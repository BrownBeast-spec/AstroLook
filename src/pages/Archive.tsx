...
import { summarizeData } from "@/lib/gemini";
...
const Archive = () => {
  ...
  const handleSummarizeData = async () => {
    ...
    try {
      const result = await summarizeData(inputData);
      setSummary(result);
      
      toast({
        title: "Data Summarized",
        description: "Successfully generated AI summary of your data",
      });
    } catch (error) {
      toast({
        title: "Error",
        description: error instanceof Error ? error.message : "Failed to summarize data",
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            Paste historical observational data or reports below to generate a concise summary using Google Gemini AI.
          </p>
        </div>
        ...
        {isLoading && (
          <Alert className="bg-blue-500/10 border-blue-500/20 mb-8">
            ...
            <AlertDescription className="text-blue-300">
              Google Gemini AI is analyzing your data and generating insights. This may take a few moments...
            </AlertDescription>
          </Alert>
        )}
          ...
          <Card className="bg-slate-800/30 border-slate-700">
            <CardContent className="py-16 text-center">
              ...
              <p className="text-gray-400 max-w-md mx-auto">
                Paste your observational data above and click "Summarize Data" to get AI-powered insights powered by Google Gemini.
              </p>
            </CardContent>
          </Card>
        )}
